                        ...
                        @foreach($products as $product)
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 col-xs-6">
                                    <div class="col-xs-12">{{$product['product_name'] }} </div>
                        ...
                        <?php $total = $subtotal + ($subtotal * $tax); ?>
                            ...
                            <div class="form-group">
                                <div class="col-xs-12">
                                    ...
                                    <div class="pull-right"><strong><span>$</span><span> {{ $subtotal }}</strong></span></div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="col-xs-12">
                                    ...
                                    <div class="pull-right"><strong> <span>$</span><span>{{ $total }} </strong> </span></div>
                                </div>
                            </div>
                        </div>
                    </div>
